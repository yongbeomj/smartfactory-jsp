...
<body>
	...
	<div style="text-align: center;">
		...
		<form action="../../controller/boardwritecontroller.jsp" method="post">
			...
			<br>재료준비
			<input type="radio" id="bmaterial1" name="bmaterial" value="완료"> <label for="drone1">완료</label>
			<input type="radio" id="bmaterial2" name="bmaterial" value="작업중"> <label for="drone1">작업중</label>
			<br>인쇄공정
			<input type="radio" id="bprint1" name="bprint" value="완료"> <label for="drone1">완료</label>
			<input type="radio" id="bprint2" name="bprint" value="작업중"> <label for="drone1">작업중</label>
			<br>코팅공정
			<input type="radio" id="bcoating1" name="bcoating" value="완료"> <label for="drone1">완료</label>
			<input type="radio" id="bcoating2" name="bcoating" value="작업중"> <label for="drone1">작업중</label>
			<br>합지공정
			<input type="radio" id="bpaper1" name="bpaper" value="완료"> <label for="drone1">완료</label>
			<input type="radio" id="bpaper2" name="bpaper" value="작업중"> <label for="drone1">작업중</label>
			<br>접합공정
			<input type="radio" id="bjoin1" name="bjoin" value="완료"> <label for="drone1">완료</label>
			<input type="radio" id="bjoin2" name="bjoin" value="작업중"> <label for="drone1">작업중</label>
			<br>포장공정
			<input type="radio" id="bpackaging1" name="bpackaging" value="완료"> <label for="drone1">완료</label>
